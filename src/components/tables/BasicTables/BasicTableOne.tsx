      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} className="max-w-md p-6">
        {selectedAppointment && (
          <div>
            ...
            <div className="mb-2"><b>Nhân viên:</b> {selectedAppointment.employeeName}</div>
            <div className="mb-2"><b>Khách hàng:</b> {selectedAppointment.userName}</div>
            <div className="mb-2"><b>Dịch vụ:</b> {selectedAppointment.serviceName.join(", ")}</div>
            <div className="mb-2">
